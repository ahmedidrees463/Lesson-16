...
window.geomatry('480x380') 



title = Label(window, text='My Profile Card', fg='white',
bg='Purple', width=40)
title.grid(row=0, column=0, columnspan=2, padx=10, pday=10)
...
hobby_label = Label(window, text='Hobby:', fg='black',
bg='white')
